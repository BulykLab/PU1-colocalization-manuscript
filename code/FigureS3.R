...
#### Figure S3 - JLIM vs Coloc scatterplot ####
...
## Figure S3a
## JLIM X Coloc O
p_supp_3a_right <- ggplot(jlim_v_coloc) + theme_classic() +
...
## JLIM O Coloc X
p_supp_3b_right <- ggplot(jlim_v_coloc) + theme_classic() +
  geom_hline(yintercept = 0.5, linetype = 2) + geom_vline(xintercept = -log10(jlim_threshold), linetype = 2) +
...
## Association plots
## example 1
pu1_stat <- read.csv('../data/FigS3/PU1_17402.qtl.txt', header = T, sep =' ')
gwas_stat <- read.csv('../data/FigS3/PU1_17402.mono_count.sumstat', header = T, sep =' ')
...
## example 2
pu1_stat <- read.csv('../data/FigS3/PU1_27131.qtl.txt', header = T, sep =' ')
gwas_stat <- read.csv('../data/FigS3/PU1_27131.MCV.sumstat', header = T, sep =' ')
...
## example 3
pu1_stat <- read.csv('../data/FigS3/PU1_54831.qtl.txt', header = T, sep =' ')
gwas_stat <- read.csv('../data/FigS3/PU1_54831.lym_count.sumstat', header = T, sep =' ')
...
## example 4
pu1_stat <- read.csv('../data/FigS3/PU1_64115.qtl.txt', header = T, sep =' ')
gwas_stat <- read.csv('../data/FigS3/PU1_64115.mono_count.sumstat', header = T, sep =' ')
...
p_supp_3a_left <- plot_grid(p_pu1_17402, p_pu1_27131,p_pu1_54831, p_pu1_64115,ncol = 2)
p_supp_3a <- plot_grid(p_supp_3a_left, NULL, p_supp_3a_right, ncol = 3, rel_widths = c(2,0.1,1))

ggsave('../figures/FigS3a.pdf',
       plot = p_supp_3a,
       device='pdf',
...
##
## example 1
pu1_stat <- read.csv('../data/FigS3/PU1_35142.qtl.txt', header = T, sep =' ')
gwas_stat <- read.csv('../data/FigS3/PU1_35142.eosino_count.sumstat', header = T, sep =' ')
...
## example 2
pu1_stat <- read.csv('../data/FigS3/PU1_47192.qtl.txt', header = T, sep =' ')
gwas_stat <- read.csv('../data/FigS3/PU1_47192.mono_percentage.sumstat', header = T, sep =' ')
...
## example 3
pu1_stat <- read.csv('../data/FigS3/PU1_58189.qtl.txt', header = T, sep =' ')
gwas_stat <- read.csv('../data/FigS3/PU1_58189.eosino_percentage.sumstat', header = T, sep =' ')
...
## example 4
pu1_stat <- read.csv('../data/FigS3/PU1_65827.qtl.txt', header = T, sep =' ')
gwas_stat <- read.csv('../data/FigS3/PU1_65827.eosino_percentage.sumstat', header = T, sep =' ')
...
## Plotting together
p_supp_3b_left <- p_pu1_35142  + p_pu1_47192 + p_gwas_35142 + p_gwas_47192 +
  p_pu1_58189  + p_pu1_65827 + p_gwas_58189 + p_gwas_65827 + plot_layout(nrow=4, ncol=2)

p_supp_3b <- plot_grid(p_supp_3b_left, NULL, p_supp_3b_right, ncol = 3, rel_widths = c(2,0.1,1))



ggsave('../figures/FigS3b.pdf',
       plot = p_supp_3b,
       device='pdf',
       width=400, height=140, units="mm")
