...
## lym count GWAS
gwas_file = "../data/Fig5/ZNF608.lym_count.metal.txt"
...
## PU1_27777
pu1_file = "../data/Fig5/PU1_27777.metal.txt"
...
## ZNF608
eqtl_file = "../data/Fig5/ZNF608.LCL_eqtl.metal.txt"
...
eqtl_cond_file = "../data/Fig5/ZNF608.LCL_cond_eqtl.metal.txt"
...
## SUSIE fine-mapping
znf608_susie <- read.csv('../data/Fig5/ZNF608.LCL_eqtl.susie.txt', header = T, sep ='\t')
...
## B cells
bcell_eqtl_file = "../data/Fig5/ZNF608.Bcell_naive_eqtl.metal.txt"
...
#### Plotting together
p_5_aefgi <- p_pu1 + theme(axis.text.x = element_blank(), axis.title.x = element_blank(), axis.text.y = element_text(size=12), axis.title.y = element_text(size=14)) + scale_y_continuous(breaks = c(0,5,10)) +
...
ggplot2::ggsave('../figures/Fig5aefgi.pdf',
                plot = p_5_aefgi,
                device='pdf',
...
PU1_27777 <- read.csv('../data/Fig5/qtl/PU1_27777.cpm.boxplot.txt', header = T, sep ='\t')

# Adding allele dosage 2 because there were no samples with homozygous alternate alleles
p_pu1_qtl_5 <- PU1_27777 %>% mutate(genotype = factor(genotype, levels=c("0", "1", "2"))) %>%
...
ATAC_59004 <- read.csv('../data/Fig5/qtl/ATAC_59004.cpm.boxplot.txt', header = T, sep ='\t')

p_atac_qtl_5 <- ggplot(ATAC_59004, aes(x=as.factor(genotype), y=cpm)) +
...
H3K4me1_5 <- read.csv('../data/Fig5/qtl/H3K4me1_5_124340065_124345334.cpm.boxplot.txt', header = T, sep ='\t')

p_h3k4me1_qtl_5 <- ggplot(H3K4me1_5, aes(x=as.factor(genotype), y=cpm)) +
...
H3K27ac_5 <- read.csv('../data/Fig5/qtl/H3K27ac_5_124339830_124348198.cpm.boxplot.txt', header = T, sep ='\t')

p_h3k27ac_qtl_5 <- ggplot(H3K27ac_5, aes(x=as.factor(genotype), y=cpm)) +
...
p_5_h <- ZNF608_RNA %>% filter(celltype %in% c("HSC", "MPP", "LMPP", "CLP",  "B", "CD4T", "CD8T", "NK")) %>%
...
## Plotting Fig5d,h together
p_5_dh <- cowplot::plot_grid(p_5_d, p_5_h, nrow = 2, rel_heights = c(5,6))

ggplot2::ggsave('../figures/Fig5dh.pdf',
                plot = p_5_dh,
                device='pdf',
