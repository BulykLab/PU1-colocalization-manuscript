...
atac_counts <-  read.table("~/Downloads/rs411_ATAC.readcount.031722.txt", header=TRUE, row.names=1)
...
write.table(as.data.frame(res_pu1ko), sep = '\t', file = '../../data/SuppFig6/res_pu1ko.txt', quote=F)
